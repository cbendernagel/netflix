<%-- 
    Document   : orderspage
    Created on : May 3, 2017, 7:20:15 PM
    Author     : reggs
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="spacing container">
            ...
            <h2 class="spacing movietitle">Orders<font color="EA6630"><b></b></font></h2>

            <ul class="spacing nav nav-pills">
                <li role="presentation"><a href="/netflix/customerspage"><h3>Customers</h3></a></li>
                <li  class="active"role="presentation"><a href="/netflix/orderspage"><h3>Orders</h3></a></li>
                <li role="presentation"><a href="/netflix/mailinglistpage"><h3>Mailing List</h3></a></li>
            </ul>
            ...
            <div class="row">
                ...
                <div class="col-md-6 spacing list-group genretable">
                        <c:forEach var="order" items="${orders}" varStatus="loop">
                            <a href="/netflix/order/${order.id}" class="list-group-item list-group-item-action">${order.id}</a>
                        </c:forEach>
                    </div>
                </div>
