<%-- 
    Document   : queue
    Created on : May 2, 2017, 6:59:16 PM
    Author     : reggs
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="spacing container">
            ...
            <h2 class="spacing movietitle">My Queue<font color="EA6630"><b></b></font></h2>

            <ul class="spacing nav nav-pills">
                <li class="active" role="presentation"><a href="/netflix/moviespage"><h3>Movies in Queue</h3></a></li>
            </ul>

            <div class="row">

                <div class="col-md-6 spacing list-group genretable">
                    <c:forEach var="movieQ" items="${movieQs}" varStatus="loop">
                        <a href="/netflix/movieinfopage/${movieQ.movie.id}" class="list-group-item list-group-item-action">${movieQ.movie.name}</a>
                    </c:forEach>
                </div>
